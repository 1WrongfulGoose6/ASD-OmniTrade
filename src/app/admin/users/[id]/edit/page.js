...
export default function EditUserPage({ params }) {
  ...
  // Dummy fetched user (replace with DB later)
  const user = {
    name: "John Smith",
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm bg-white 
                           focus:border-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-40"
              >
            ...
            <button
              type="submit"
              className="w-full rounded-lg bg-blue-600 px-4 py-2 font-medium text-white shadow hover:bg-blue-700 cursor-pointer"
            >
              Save Changes
            </button>
          </form>
