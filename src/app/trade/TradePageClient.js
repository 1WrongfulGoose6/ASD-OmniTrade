...
export default function TradePageClient() {
  ...
  return (
    <div className="flex flex-col min-h-screen p-8 px-32 bg-gradient-to-br from-blue-600 to-blue-400 relative overflow-hidden">
      ...
      {/* Content */}
      <main className="relative z-10 flex flex-col md:flex-row gap-6 mt-6">
        {/* Left: Chart + Orders */}
        <section className="flex-1 flex flex-col gap-4">
          {/* Mini-summary */}
          <div className="relative bg-white/90 rounded-2xl p-4 shadow-sm flex flex-col items-center">
            <a
          ...
          {/* Chart */}
          <div className="bg-white/90 rounded-2xl shadow-lg p-4 h-[35vh] md:h-[30vh] overflow-hidden">
            <GraphSection />
          </div>

          {/* Pending Orders */}
          <div className="bg-white/90 rounded-2xl shadow-lg p-4 mt-4 overflow-x-auto">
